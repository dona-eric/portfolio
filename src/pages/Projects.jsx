...
const PROJECTS_DATA = [
  ...
  {
    id: 6,
    title: "Sentiment Aanalysis",
    description: "Analyse de Satisfaction Client",
    longDescription: "Analyse de satisfaction de la clientèle. C'est un sujet très important qui concerne la majorité des structures et des entreprises qui s'impliquent dans la clientèle",
    technologies: ["Python", "FastAPI", "StreamlitCloud", "Pandas","Seaborn", "Scikit-Learn", "LLMs(Bert)"],
    category: "AI/ML",
    status: "Terminé",
    icon: Code,
    color: "from-purple-500 to-pink-600",
