...
const PROJECTS_DATA = [
  {
    ...
    technologies: ["Python", "BERT", "Transformers", "FastAPI", "React", "PostgreSQL", "Docker"],
    category: "AI/ML",
    status: "Terminé",
    icon: Shield,
    color: "from-green-500 to-emerald-600",
    features: ["NLP avancé", "Analyse temps réel", "API REST", "Interface web", "Scoring fiabilité", "Export rapports"],
    github: "https://github.com/dona-eric/veritaai",
    demo: "https://veritaai-demo.com",
    image: "🛡️",
    difficulty: "Expert",
    duration: "6 mois",
  ...
  },
  {
    ...
    github: "https://github.com/username/saferoute-benin",
    demo: "https://saferoute-demo.com",
    image: "🚗",
    difficulty: "Avancé",
    duration: "8 mois",
    impact: "1000+ utilisateurs actifs"
  },
  {
    id: 3,
    title: "Dashboard VE",
    ...
    longDescription: "Dashboard interactif pour analyser les patterns de recharge et optimiser les coûts énergétiques. Utilise des modèles ML pour prédire les besoins énergétiques et proposer des stratégies d'optimisation.",
    technologies: ["Python", "Streamlit", "Plotly", "Pandas", "ML Models", "TimeSeries", "AWS"],
    category: "Data Viz",
    status: "Terminé",
    icon: Zap,
    color: "from-yellow-500 to-orange-600",
    features: ["Viz interactives", "Prédictions ML", "Optimisation coûts", "Rapports auto", "Alertes seuils", "API intégration"],
    github: "https://github.com/username/dashboard-ve",
    demo: "https://dashboard-ve-demo.com",
    image: "⚡",
  ...
  },
  {
    ...
    description: "Générateur de contenu automatisé utilisant GPT et des modèles custom pour créer du contenu marketing personnalisé et optimisé SEO.",
    longDescription: "Plateforme complète de génération de contenu utilisant l'IA pour créer automatiquement des articles de blog, posts sociaux et contenus marketing optimisés pour le SEO et adaptés à chaque audience.",
    technologies: ["Python", "OpenAI API", "Flask", "Vue.js", "Redis", "Celery", "Docker"],
    category: "AI/ML",
    status: "En cours",
    icon: Code,
    color: "from-purple-500 to-pink-600",
    features: ["Génération auto", "SEO optimisé", "Multi-formats", "Personnalisation", "Planning contenu", "Analytics"],
    github: "https://github.com/username/ai-content-gen",
    demo: "https://ai-content-demo.com",
    image: "🤖",
    difficulty: "Expert",
    duration: "5 mois",
    impact: "50% temps économisé"
  }
];

const CATEGORIES = ["Tous", "AI/ML", "Mobile", "Data Viz"];
